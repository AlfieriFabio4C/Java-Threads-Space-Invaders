...
public class Intro extends Space {
    ...
    public void disegna(int n, boolean scritte) throws IOException {
        ...
        g.setFont(new Font("Bold", Font.ITALIC, 40 + j));
        g.drawString("Space Invaders", 100 + j, 100 + j);
        g.setFont(new Font("Bold", Font.ITALIC, 10 + j));
        g.drawString("          by Fabio Alfieri", 110 + j + j, 110 + j + j);
        ...
        g.drawImage(ship, Sx, 400, 160, 140, null);
        int bng;
        bng = 0;
